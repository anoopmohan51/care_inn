...
from workorder_api.views.workorder_escalations_log.workorder_escalation_details import *
...
urlpatterns = [
    ...
    path('escalation-details/<int:workorder_id>',WorkorderEscalationDetailsView.as_view()),
]