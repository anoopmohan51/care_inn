...
from workorder_api.models import WorkOrderAttributeIcons
    ...
    def post(self, request):
        try:
            ...
            for file in files:
                ...
                relative_path = f"{upload_subdir}/{unique_filename}"
...
class DeleteWorkOrderAttributeIconView(APIView):
    def delete(self, request, pk):
        try:
            workorder_attribute_icon = WorkOrderAttributeIcons.objects.get(id=pk, is_delete=False)
