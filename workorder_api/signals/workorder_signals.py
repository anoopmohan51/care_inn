    ...
    try:
        if created:
            ...
            if instance.user_group or instance.user:
                print("instance.user_group::::::::::::::::::::::",instance.user_group.id)
            ...
            if original:
                ...
                if original.priority != instance.priority:
                    ...
                    if instance.status==WorkOrder.WORKORDER_STATUS_IN_PROGRESS:
                        changes.append({
                        ...
                        if instance.status==WorkOrder.WORKORDER_STATUS_ASSIGNED_NOT_STARTED and \
                            original.status==WorkOrder.WORKORDER_STATUS_CLOSED:
                            changes.append({
                                'activity': 'STATUS',
